%WORKSHEET_Geometry_and_kernels
%
% Requirements:
...
%% (Exercise 2) if extra time: chunking ellipses
%
...
%% (Section 2) more complicated geometries with chunkgraphs
%
